...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : oldLocations) {
                    LocationData oldLocation = ds.getValue(LocationData.class);
                    LatLng loc = new LatLng(oldLocation.latitude, oldLocation.longitude);
                    long epoch = Long.parseLong(ds.getKey());
                    Timestamp timestamp = new Timestamp(epoch);
                    String label = format.format(timestamp);
                    mMap.addMarker(new MarkerOptions().position(loc).title(label).icon(BitmapDescriptorFactory.defaultMarker(i)));
                    i += 30;
                    if(i > 360) {
                        i -= 360;
                    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(eng).title("Alice Perry Engineering Building"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(eng,15));
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        mDatabase.child("locations").child(String.valueOf(System.currentTimeMillis())).setValue(locationData);
    }
